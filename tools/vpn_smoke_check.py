...
CHECKS = [
    ...
    Check("SSH hardening regression", ["tools/test_ssh_hardening.py"]),
    ...
    Check("control backup verification regression", ["tools/test_verify_control_backup.py"]),
    Check("control restore rehearsal regression", ["tools/test_rehearse_control_restore.py"]),
    ...
    Check(
        ...
        [
            "tools/check_control_server_prod.py",
            "--strict",
            "--via-cudy",
            "--timeout",
            "60",
